...
import (
	...
	log "github.com/jruszo/trafficcontrol/v8/lib/go-log"
	"github.com/kelseyhightower/envconfig"
)

// Config reflects the structure of the test-to-api.conf file. It also
// implements github.com/jruszo/trafficcontrol/v8/lib/go-log.Config for logging.
type Config struct {
...
// github.com/jruszo/trafficcontrol/v8/lib/go-log package.
