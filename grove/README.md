...
```bash
mkdir -p $GOPATH/src/github.com/jruszo/trafficcontrol
cd $GOPATH/src/github.com/jruszo/trafficcontrol
git clone https://github.com/jruszo/trafficcontrol/grove
```
...
Note there exists a tool for generating remap rules from [Traffic Control](https://github.com/jruszo/trafficcontrol), available [here](https://github.com/jruszo/trafficcontrol/tree/master/grove/grovetccfg).
