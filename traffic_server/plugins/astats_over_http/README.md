...
Deb Builds
  ...
  named astats_over_htt-.tar.gz is copied to the debbuild/SOURCES directory.  The second
  astats-git-build, checks out the source from the git repo and builds the deb.
