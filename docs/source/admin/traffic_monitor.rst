...
#. Install Traffic Monitor, either from source or by installing a :file:`traffic_monitor-{version string}.deb` package generated by the instructions in :ref:`dev-building` with :manpage:`apt(8)` or :manpage:`deb(8)`
